#!/usr/bin/env python3
"""
Convert BLOG_Referral_App_Odoo_19_V2_VERIFIED.md to a professional Word (.docx) document.
...
if __name__ == "__main__":
    base = r"c:\Odoo Study"
    md_path = os.path.join(base, "BLOG_Referral_App_Odoo_19_V2_VERIFIED.md")
    docx_path = os.path.join(base, "My learnings", "Rohan_Documentation", "BLOG_Referral_App_V2_VERIFIED.docx")
